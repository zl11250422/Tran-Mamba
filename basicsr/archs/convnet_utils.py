...
def build_model(arch):
    if arch == 'ResNet-18':
        ...
        model = DAT(img_size=64, in_chans=3,upscale=4,img_range=1.,depth=[14],embed_dim=60,num_heads=[6],expansion_factor=2,resi_connection='3conv',split_size=[8,32],upsampler='pixelshuffledirect')
    else:
