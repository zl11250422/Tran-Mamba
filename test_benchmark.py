...
def main():
    ...
    model_path = r'/home/zl/Downloads/SISR/mbmt/experiments/ablation_light_x4/models/net_g_100.pth'
    model = DAT(upscale=4,in_chans=3,img_size=64,img_range=1.,depth=[14],embed_dim=60,num_heads=[6],expansion_factor=2,resi_connection='3conv',split_size=[8,32],upsampler='pixelshuffledirect')
    ...
    L_folder = r'/media/zl/5C007C40007C2366/Users/lzhan/Desktop/sisr/SISR/BSRN/BSRN/datasets/Manga109/LRbicx4/'
